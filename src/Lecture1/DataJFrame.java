...
public class DataJFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //GİRİŞ Butonu işlemleri

        int no = Integer.parseInt(jTextField1.getText());
        String isim = jTextField2.getText();
        char cinsiyet = jTextField3.getText().charAt(0);
        int vize = Integer.parseInt(jTextField4.getText());
        int genel = Integer.parseInt(jTextField5.getText());

        o[i] = new ogrenci(no, isim, vize, genel, cinsiyet);
        jLabel9.setText(o[i].isim + " Öğrenci Bilgileri Kayıt Edildi..");

    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //ORTALAMA Butonu İşlemleri

        double ort = o[0].ortalama();
        jLabel8.setText(String.valueOf(ort));
