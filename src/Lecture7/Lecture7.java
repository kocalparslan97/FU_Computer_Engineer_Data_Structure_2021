...
public class Lecture7 {
    ...
    //create removeAll() method to mae AVL Tree Empty
    public void removeAll() {
        rootNode = null;
    }

    //create checkEmpty() method to check whether the
    //AVL Tree is empty or not
    ...
    //create maxNode() method to get the maximum height from
    //left and right node
    ...
    private Node insertElement(int element, Node node) {
        ...
        if (node == null) {
            ...
            //insert a node in case when the given element is lesser than
    ...
    //craeting rotateWithLeftChild() method to perform rotation of
    //binary tree node with left child
    ...
    //creating rotateWithRightChild() method to perform rotation of
    //binary tree node with right child
    ...
    //create doubleWithLeftChild() method to perform double rotation of
    //binary tree node . This method first rotate the left child with
    //its right child , and after that , node3 with the new left child
    ...
    //create doubleWithLeftChild() method to perform double rotation of
    //binary tree node . This method first rotate the right child with
    //its right child , and after that , node3 with the new right child
    ...
    //create getTotalNumberOfNodes() method to get total number of nodes
    //in the AVL Tree
    ...
    //creat einorderTraversal() method for traversing
    //AVL Tree in in-order form
    ...
    //create preorderTraversal() method for traversing AVL Tree in
    //pre-order form
    ...
    //create postorderTraversal() method fro traversing
    //AVL Tree post-order form
    ...
    public static void main(String[] args) {
        ...
        //create object of Lecture7 class object for costructing
        //AVL Tree
        ...
        do {
            ...
            switch (ch) {
                case 1:
                    ...
                    obj.insertElement(s.nextInt());
                    break;
                case 2:
                    System.out.println("Enter integer element to search");
                    System.out.println(obj.searchElement(s.nextInt()));
                    break;
                case 3:
